...
/* US_handler/Emergency_stop_SM: */
typedef enum kcg_tag_SSM_TR_Emergency_stop_SM {
  SSM_TR_no_trans_Emergency_stop_SM,
...
/* US_handler/Emergency_stop_SM: */
typedef enum kcg_tag_SSM_ST_Emergency_stop_SM {
  SSM_st_IDLE_Emergency_stop_SM,
  SSM_st_Stop_Emergency_stop_SM,
